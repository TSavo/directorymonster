...
import { useActivityFeedState } from '@/components/admin/dashboard/hooks/useActivityFeedState';
import { ActivityItem } from '@/components/admin/dashboard/types';

// Mock the hook
jest.mock('../../../src/components/admin/dashboard/hooks/useActivityFeedState', () => ({
  useActivityFeedState: jest.fn(),
}));
...
describe('ActivityFeed Component', () => {
  ...
  beforeEach(() => {
    ...
    (useActivityFeedState as jest.Mock).mockReturnValue({
