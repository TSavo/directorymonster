...
describe('SiteMobileCard Component - Interaction', () => {
  ...
  it('calls onEdit when edit button is clicked', async () => {
    ...
    const editButton = screen.getByTestId('mobile-edit-button');
  ...
  it('calls onDelete when delete button is clicked', async () => {
    ...
    const deleteButton = screen.getByTestId('mobile-delete-button');
  ...
  it('expands/collapses details when card is clicked', async () => {
    ...
    const card = screen.getByTestId('mobile-site-card');
