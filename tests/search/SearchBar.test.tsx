...
describe('SearchBar Component', () => {
  ...
  it('does not include site ID in search URL when provided (site context from middleware)', () => {
    const mockPush = jest.fn();
    jest.spyOn(require('next/navigation'), 'useRouter').mockImplementation(() => ({
      push: mockPush,
    }));
    ...
    // Verify router.push is called without site ID in URL (site context from middleware)
