...
/**
 * POST handler for assigning a global role to a user
 *
  ...
  return withSecureTenantPermission(
    ...
    async (validatedReq, context) => {
      try {
        ...
        await RoleService.assignGlobalRoleToUser(roleId, body.userId, body.tenantId);
        ...
        await AuditService.log({
          ...
          details: {
            ...
            assignedTenantId: body.tenantId
          }
        });
