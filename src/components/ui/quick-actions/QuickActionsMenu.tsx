...
export function QuickActionsMenu({ className = '' }: QuickActionsMenuProps) {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="p-0 bg-white/95 backdrop-blur-sm border border-neutral-100 shadow-lg rounded-xl animate-fade-in" align="end" side="bottom" sideOffset={8} alignOffset={0} forceMount>
        <Command>
          <CommandInput placeholder="Search actions..." />
          <CommandList>
            <CommandEmpty>No actions found.</CommandEmpty>
            <CommandGroup heading="Quick Actions" className="text-primary-600 font-medium">
