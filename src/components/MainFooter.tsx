        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/" className="text-neutral-300 hover:text-white transition-colors focus-visible">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-neutral-300 hover:text-white transition-colors focus-visible">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-neutral-300 hover:text-white transition-colors focus-visible">
                  Contact
                </Link>
              </li>
              <li>
                <Link href="/search" className="text-neutral-300 hover:text-white transition-colors focus-visible">
                  Advanced Search
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/privacy" className="text-neutral-300 hover:text-white transition-colors focus-visible">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-neutral-300 hover:text-white transition-colors focus-visible">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link href="/cookies" className="text-neutral-300 hover:text-white transition-colors focus-visible">
                  Cookie Policy
                </Link>
              </li>
              <li>
                <Link href="/sitemap.xml" className="text-neutral-300 hover:text-white transition-colors focus-visible">
                  Sitemap
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-neutral-300">
              ...
              <li className="flex items-center">
                ...
                <span>123 Directory St, City, Country</span>
              </li>
            </ul>
          </div>
        </div>
