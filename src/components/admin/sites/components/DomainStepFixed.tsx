...
export const DomainStep: React.FC = () => {
  ...
  const addDomain = () => {
    ...
    // Clear any domain-related errors in the form context
    if (errors.domains) {
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center">
          <input
            ...
            className={`flex-grow p-2 border rounded focus:ring-2 focus:border-blue-500 ${combinedErrors.newDomain ? 'border-red-500' : 'border-gray-300'}`}
            aria-invalid={!!combinedErrors.newDomain}
            aria-describedby={combinedErrors.newDomain ? "domainStep-domain-input-error" : undefined}
