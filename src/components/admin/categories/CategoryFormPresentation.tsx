...
import { CategoryFormData, ValidationErrors } from './components/form/types';
import {
  TextInput,
  TextArea,
  SelectField,
...
export interface CategoryFormPresentationProps {
  // Form data and state
...
export function CategoryFormPresentation({
  formData,
  touched,
  validationErrors,
  isLoading,
...
export default CategoryFormPresentation;
