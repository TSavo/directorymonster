...
export function ListingTableEmptyState({ siteSlug }: ListingTableEmptyStateProps) {
  ...
  return (
    <div className="text-center p-8 border rounded-lg bg-gray-50" data-testid="listings-empty">
      <p className="text-gray-500 mb-4" data-testid="empty-listings-message">No listings found</p>
      <Link
        href={createUrl}
