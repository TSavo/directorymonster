...
export default async function Home({ searchParams }: PageProps) {
  ...
  if (site) {
    ...
    ).then(categories => categories.filter(Boolean)); // Filter out null values
    ...
    // FETCH ALL DATA UPFRONT INSTEAD OF USING ASYNC COMPONENTS
    
    // Get all categories for this site for featured listings
    const allCategories = [...categories];
    
    // Get all listings across all categories
    let allListings: (Listing & { categorySlug?: string })[] = [];
    for (const category of allCategories) {
      ...
      const listings = await Promise.all(
        listingKeys.map(async (key) => {
          ...
          if (listing) {
            // Add category slug to the listing for convenience
            return { ...listing, categorySlug: category.slug };
          }
          return null;
        })
      );
      
      // Add these listings to our array
      allListings = [...allListings, ...listings.filter(Boolean) as (Listing & { categorySlug?: string })[]];
    }
    
    // Featured listings - get top 3 by rating
    const featuredListings = [...allListings].sort((a, b) => {
      const ratingA = a.customFields?.rating ? Number(a.customFields.rating) : 0;
      const ratingB = b.customFields?.rating ? Number(b.customFields.rating) : 0;
      return ratingB - ratingA;
    }).slice(0, 3);
    
    // Recent listings - get top 4 by date
    const recentListings = [...allListings].sort((a, b) => {
      return new Date(b.updatedAt).getTime() - new Date(a.updatedAt).getTime();
    }).slice(0, 4);
    
    // Determine if we have any listings
      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">Discover our top-rated products selected just for you</p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8" itemScope itemType="https://schema.org/ItemList">
                {featuredListings.map((listing, index) => (
                  ...
                  >
                    ...
                    <ListingCard listing={listing} site={site} />
                  </div>
                ))}
                ...
                {!hasListings && (
                  <div className="col-span-full bg-white p-8 rounded-lg shadow text-center">
                    <p className="text-gray-500">No listings found. Try seeding data first.</p>
        ...
        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Explore our curated collection of categories</p>
          </div>
            ...
            {categories.map((category, index) => (
              ...
              >
                <CategoryLink 
                  ...
                  className="group"
                >
                  <div className="bg-white overflow-hidden shadow-md rounded-lg hover:shadow-xl transition duration-300 h-full flex flex-col border border-gray-100">
                    ...
                    <div className="bg-gray-50 px-6 py-4 border-t border-gray-100">
                      <div className="text-sm font-medium text-blue-600 group-hover:text-blue-800 flex items-center">
        ...
        <div className="bg-gray-50 py-16 border-t border-gray-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">Check out our most recent listings</p>
            </div>
            
            <div className="mt-10">
              {/* Recent listings grid */}
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6" itemScope itemType="https://schema.org/ItemList">
        ...
        <footer className="bg-gray-50 border-t">
          <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xs text-gray-400 mt-1">Hostname: {hostname}</p>
          </div>
        </footer>
      </main>
    );
